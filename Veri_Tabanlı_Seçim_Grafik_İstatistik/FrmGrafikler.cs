...
namespace Veri_Tabanlı_Seçim_Grafik_İstatistik
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=LAPTOP-FB9086OP;Initial Catalog=DBSECİMPROJE;Integrated Security=True");
